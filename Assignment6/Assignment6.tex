...
\begin{enumerate}
    \item \pr{X_n>\log n \text{ for infinitely many }n\geq1}=1\\
    \item \pr{X_n>2 \text{ for infinitely many }n\geq1}=1\\
    \item \pr{X_n>\frac{1}{2} \text{ for infinitely many }n\geq1}=0\\
    \item \pr{X_n>\log n,X_{n+1}>\log (n+1)\text{ for infinitely many }n\geq1}=0
\end{enumerate}
\section{SOLUTION}
PDF of $X_i$ is
\begin{align}
